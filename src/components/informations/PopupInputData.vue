<template>
  ...
  >
    <div
      class="w-[500px] h-fit bg-white rounded-[10px] flex p-6 flex-col gap-3"
      @click.stop=""
    >
      ...
      <div class="flex gap-2">
        <button
          class="bg-[#1e90ff] text-white rounded-[20px] px-4 py-1"
          @click="submit"
        >
          Lưu
        </button>
        <button class="bg-[#1e90ff] text-white rounded-[20px] px-4 py-1">
          Hủy
        </button>
      </div>
    </div>
