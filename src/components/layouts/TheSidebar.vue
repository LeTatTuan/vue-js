<template>
  <div class="">
    ...
    >
      ...
      <div
        class="mt-[10px] py-5 px-5 flex flex-col gap-2 max-[400px]:flex-row max-[400px]:justify-around"
      >
        <router-link
          to="/"
          class="hover:bg-slate-100 cursor-pointer py-3 rounded-[8px] items-center gap-3 flex flex-col"
          :class="{
            'bg-[#5d87ff_!important] text-white hover:bg-[#5d87ff]':
              isDashboard,
          }"
        >
          <svg
        ...
        <div
          class="hover:bg-slate-100 cursor-pointer py-3 text-center rounded-[8px] flex items-center gap-3 flex-col"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="25"
